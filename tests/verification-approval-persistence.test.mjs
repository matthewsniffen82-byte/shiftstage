...
test("new dancers stay private until first-venue NFC approval while existing approved profiles remain live", () => {
  ...
  assert.match(liveApp, /tap its official dressing-room NFC sticker/i);
