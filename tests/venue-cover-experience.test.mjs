...
test("venue cards use only official logos or branded monograms", () => {
  ...
  assert.match(homeSource, /home-venue-discovery-location[\s\S]*?home-venue-discovery-action-rail[\s\S]*?home-venue-discovery-profile-action[\s\S]*?data-open-venue-profile[\s\S]*?data-share-venue/);
  assert.doesNotMatch(
