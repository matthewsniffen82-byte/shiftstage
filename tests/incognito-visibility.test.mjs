...
test("incognito uses a dedicated authenticated database operation", () => {
  ...
  assert.match(routeSource, /verification_status, venue_approved_at, disabled_at, is_public/);
  assert.doesNotMatch(routeSource, /identity_provider|identity_verified_at|isVerifyMyIdentityMode/);
