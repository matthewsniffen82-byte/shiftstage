...
test("preview, cashier-tap selection, and saving are separate intentional actions", () => {
  ...
  assert.match(liveSource, /<div class="deal-pass-actions">\s*<button[^>]*data-save-deal-pass/);
  ...
  assert.match(liveSource, /function selectDealPassForNfc[\s\S]*?window\.location\.assign\(`\/deals\/transportation/);
