...
test("venue profile hierarchy stays compact and carries the restrained venue brand signature", () => {
  ...
  assert.match(refinement, /Compact venue travel actions keep both boxes identical[\s\S]*?height: 52px !important;[\s\S]*?padding: 0 38px !important;[\s\S]*?text-align: center !important;/);
