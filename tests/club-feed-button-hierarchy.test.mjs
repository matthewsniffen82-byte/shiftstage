...
test("mobile Clubs cards keep one contrasting charcoal-violet header texture and a prominent active Deal", () => {
  ...
  assert.match(parity, /\.home-venue-discovery-art:not\(\.has-custom-photo\) \{[\s\S]*?background-color: #302e33 !important;[\s\S]*?rgba\(248, 250, 252, 0\.075\)[\s\S]*?rgba\(248, 250, 252, 0\.08\)[\s\S]*?rgba\(139, 92, 246, 0\.16\)[\s\S]*?#49454b 0%[\s\S]*?#2a282d 66%[\s\S]*?#3a363c 100%[\s\S]*?inset 0 -1px 0 rgba\(167, 139, 250, 0\.22\)/);
