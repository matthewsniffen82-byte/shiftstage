...
test("mobile Clubs cards compensate iPhone and Android charcoal-violet rendering without changing the active Deal", () => {
  ...
  assert.match(parity, /\.home-venue-discovery-art:not\(\.has-custom-photo\) \{[\s\S]*?background-color: #18171b !important;[\s\S]*?rgba\(248, 250, 252, 0\.055\)[\s\S]*?rgba\(248, 250, 252, 0\.04\)[\s\S]*?rgba\(139, 92, 246, 0\.13\)[\s\S]*?#28262b 0%[\s\S]*?#111015 66%[\s\S]*?#1e1b21 100%[\s\S]*?inset 0 -1px 0 rgba\(167, 139, 250, 0\.20\)/);
