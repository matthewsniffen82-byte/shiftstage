...
test("iPhone, Android, and Next pages share the Android floating glass dock", () => {
  assert.match(
    navigationSource,
    /\.global-mobile-bottom-nav \{[\s\S]*?bottom: calc\(8px \+ env\(safe-area-inset-bottom\)\)[\s\S]*?width: min\(calc\(100% - 16px\), 700px\)[\s\S]*?height: 64px[\s\S]*?border: 1px solid rgba\(248, 250, 252, 0\.09\)[\s\S]*?rgba\(9, 9, 12, 0\.82\)[\s\S]*?0 18px 46px rgba\(0, 0, 0, 0\.46\)[\s\S]*?inset 0 0 0 1px rgba\(255, 255, 255, 0\.026\)[\s\S]*?backdrop-filter: none;/,
  );
  assert.match(
    homeSource,
    /#discoveryTabs \{[\s\S]*?bottom: calc\(8px \+ env\(safe-area-inset-bottom\)\)[\s\S]*?width: min\(calc\(100% - 16px\), 700px\) !important[\s\S]*?height: 64px[\s\S]*?border: 1px solid rgba\(248,250,252,\.09\) !important[\s\S]*?rgba\(9,9,12,\.82\)[\s\S]*?0 18px 46px rgba\(0,0,0,\.46\)[\s\S]*?inset 0 0 0 1px rgba\(255,255,255,\.026\) !important[\s\S]*?backdrop-filter: none !important;/,
  );
  assert.match(
    navigationSource,
...
test("neutral mobile glass uses soft-white idle icons and a contained circular active halo", () => {
  assert.match(
    navigationSource,
  ...
  assert.match(
    navigationSource,
    /\.mobile-nav-selection-halo::before \{[\s\S]*?inset: 8px;[\s\S]*?radial-gradient\([\s\S]*?circle,[\s\S]*?rgba\(124, 58, 237, 0\.62\) 0%[\s\S]*?rgba\(124, 58, 237, 0\.42\) 30%[\s\S]*?rgba\(76, 29, 149, 0\.2\) 54%[\s\S]*?0 0 14px rgba\(76, 29, 149, 0\.18\)[\s\S]*?filter: blur\(1px\);/,
  );
  assert.match(
    navigationSource,
  ...
  assert.match(
    homeSource,
    /#discoveryTabs \.mobile-nav-selection-halo::before \{[\s\S]*?inset: 8px;[\s\S]*?radial-gradient\(circle,rgba\(124,58,237,.62\) 0%,rgba\(124,58,237,.42\) 30%,rgba\(76,29,149,.2\) 54%,transparent 74%\)[\s\S]*?0 0 14px rgba\(76,29,149,.18\)[\s\S]*?filter: blur\(1px\);/,
  );
  assert.match(
    homeSource,
  ...
  assert.match(
    navigationSource,
    /a\.active \.global-mobile-nav-icon > svg \{[\s\S]*?drop-shadow\(0 0 2px var\(--mobile-nav-active-violet-core\)\)[\s\S]*?drop-shadow\(0 0 5px var\(--mobile-nav-active-violet-glow\)\)/,
  );
  assert.match(
    navigationSource,
  ...
  assert.match(
    navigationSource,
    /--mobile-nav-accent: rgba\(232, 230, 238, 0\.74\);[\s\S]*?--mobile-nav-accent-soft: rgba\(232, 230, 238, 0\.66\);[\s\S]*?--mobile-nav-active: #fff;[\s\S]*?--mobile-nav-active-violet-core: rgba\(124, 58, 237, 0\.76\);[\s\S]*?--mobile-nav-active-violet-glow: rgba\(124, 58, 237, 0\.34\);/,
  );
  assert.match(
    homeSource,
    /--home-nav-accent: rgba\(232,230,238,.74\);[\s\S]*?--home-nav-accent-soft: rgba\(232,230,238,.66\);[\s\S]*?--home-nav-active: #fff;[\s\S]*?--home-nav-active-violet-core: rgba\(124,58,237,.76\);[\s\S]*?--home-nav-active-violet-glow: rgba\(124,58,237,.34\);/,
  );
  assert.doesNotMatch(
    navigationSource,
