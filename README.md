...
3. Reconcile the deployed schema and apply only reviewed pending Supabase migrations using the [migration safety procedure](docs/supabase-reliability/migration-safety.md). Historical files contain quarantined version collisions and must not be blindly replayed.
