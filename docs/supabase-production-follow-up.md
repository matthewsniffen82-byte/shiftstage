...
8. **Existing unvalidated constraints.** The TV duration check was validated on 2026-09-07 after all existing rows passed. The Club Deal check still has one inactive historical exception. Preserve that history and the current protection for new writes; resolve any desired historical edit through the existing moderation workflow. Do not delete records or weaken checks to force validation.
