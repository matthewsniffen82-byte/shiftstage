...
Owners and roster managers can remove individual dancers in **Affiliated dancers**. Removal immediately ends that club's current check-in. A returning dancer can reconnect by tapping the club's active dressing-room sticker again, without a separate owner or manager approval. The normal account, verification, sticker, and tap cooldown checks still apply. A dancer leaving voluntarily can remove their own affiliation through the existing dancer control.
