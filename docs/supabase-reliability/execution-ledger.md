...
| 13 | Privileged functions/RPC/webhooks | Closing review validated; exact delivery pending | Prior corrections deployed; caller review and applied-migration protection described in step-13-caller-review.md. Exact delivery of this closure is still required. |
