...
The fix was deployed as `d22462c5bd27675def76675af3f64e5e9a307fd8` with successful exact-commit Vercel status. Both migrations were applied and independently verified at 12:57 UTC, with existing records unchanged and only their own ledger entries added. Production health, corrected anonymous admin denials, callback regression and 30 readiness checks passed afterward. The execution ledger records the immutable SQL hashes and the required migration-freeze follow-up.
