...
| 12 | Frontend exceptions, loading/empty/error states and interrupted navigation | Validated: 7,770 tests, TypeScript, lint, build and 41 readiness checks; delivery receipt follows |
