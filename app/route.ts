...
export async function GET() {
  ...
  const withLiveProfileAssets = withBase.replace(
    "</head>",
    `<link rel="stylesheet" href="/mobile-social-strip.css?v=4"><link rel="stylesheet" href="/third-party-social-link-warning.css?v=2"><script src="/video-autoplay-recovery.js?v=3" defer></script><script src="/third-party-social-link-warning.js?v=1" defer></script>${ADMIN_AUTH_ENTRY_STYLES}</head>`,
  );
