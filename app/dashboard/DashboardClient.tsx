      ...
      {isOpen ? (
        ...
        >
          <div className="public-profile-shell dancer-profile-preview-shell">
            ...
            {isEditor ? (
              <>
                <section className="profile-schedule-section" aria-labelledby="dancer-profile-builder-schedule-heading">
            ...
            {isEditor && onEditorSave ? (
              <footer className="dancer-profile-editor-footer">
                <p role="status" aria-live="polite">{editorStatus || (builderRequirements?.length ? `${completedRequirements}/${builderRequirements.length} required` : "Save changes when finished")}</p>
...
function DashboardStyles() {
  return (
    <style>{`
      ...
      .dancer-profile-preview-overlay .profile-media-play { position:absolute; top:50%; left:50%; width:30px; aspect-ratio:1; border-radius:50%; background:rgba(255,255,255,.86); box-shadow:0 7px 22px rgba(0,0,0,.36); transform:translate(-50%,-50%); }
      .dancer-profile-preview-overlay .profile-media-play::after { content:""; position:absolute; top:50%; left:54%; border-top:6px solid transparent; border-bottom:6px solid transparent; border-left:9px solid #111; transform:translate(-50%,-50%); }
      .dancer-profile-preview-overlay .profile-media-duration { position:absolute; right:6px; bottom:6px; padding:4px 6px; border-radius:999px; color:#fff; background:rgba(0,0,0,.78); font-size:9px; font-weight:950; }
      ...
      .dancer-profile-preview-overlay .profile-media-viewer-stage { position:relative; min-height:0; display:grid; place-items:center; overflow:hidden; touch-action:none; }
      .dancer-profile-preview-overlay .profile-media-viewer-stage > img, .dancer-profile-preview-overlay .profile-media-viewer-stage > video { width:100%; height:100%; max-height:100%; display:block; object-fit:contain; background:#000; user-select:none; }
      .dancer-profile-preview-overlay .profile-media-viewer-stage > img { filter:brightness(1.14) contrast(1.03); }
      ...
      .dancer-profile-preview-overlay .live-actions { position:relative; display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:8px; padding:14px 0 12px; }
      ...
      .dancer-profile-preview-overlay .live-actions .profile-action-going { grid-column:1 / -1; min-height:54px; flex-direction:column; gap:2px; }
