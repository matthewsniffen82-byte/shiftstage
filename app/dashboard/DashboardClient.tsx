...
type CustomerVenueFollow = NonNullable<CustomerSavedState["venueFollows"]>[number];
...
function CustomerDashboardNav({ saved }: { saved?: CustomerSavedState | null }) {
...
function DashboardStyles() {
  return (
    <style>{`
      ...
      .dancer-profile-preview-overlay .profile-media-viewer-slide > img, .dancer-profile-preview-overlay .profile-media-viewer-slide > video { position:relative; z-index:1; width:100%; height:100%; min-width:0; min-height:0; max-height:100%; display:block; object-fit:contain; background:transparent; user-select:none; }
