...
function DashboardStyles() {
  return (
    <style>{`
      ...
      .dancer-profile-preview-overlay .dancer-profile-preview-actions .profile-action-icon-frame[data-profile-action-icon="personPlus"] .profile-action-preview-icon, .dancer-profile-preview-overlay .dancer-profile-preview-actions .profile-action-icon-frame[data-profile-action-icon="ride"] .profile-action-preview-icon { width:16.25px; height:16.25px; }
      ...
      .dancer-profile-preview-overlay .dancer-profile-preview-actions .profile-action-icon-frame[data-profile-action-icon="directions"] .profile-action-preview-icon, .dancer-profile-preview-overlay .dancer-profile-preview-actions .profile-action-icon-frame[data-profile-action-icon="share"] .profile-action-preview-icon { width:13px; height:13px; }
