...
function DashboardStyles() {
  return (
    <style>{`
      ...
      .dashboard-head-venue h1 { font-size: clamp(18px, 4.4vw, 22px); }
      ...
      @media (max-width: 520px) { .dashboard-head { padding: 10px 12px 14px; border-radius: 16px; } .dashboard-head-row { gap: 10px; } .dashboard-head h1, h1 { font-size: clamp(21px, 6vw, 26px); } .dashboard-head-venue h1 { font-size: clamp(18px, 5vw, 21px); } .dashboard-close { flex-basis: 42px; } .notification-title-row { align-items: flex-start; } }
