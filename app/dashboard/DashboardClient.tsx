...
function DashboardStyles() {
  return (
    <style>{`
      ...
      .dancer-profile-preview-overlay .profile-media-grid-item.is-photo::before { position:absolute; z-index:0; inset:0; content:""; background:radial-gradient(circle at 68% 20%, rgba(126,234,255,.12), transparent 34%), radial-gradient(circle at 20% 82%, rgba(139,92,246,.2), transparent 42%), linear-gradient(145deg,#111118,#07070b); }
      ...
      .dancer-profile-preview-overlay .profile-media-viewer-slide > img, .dancer-profile-preview-overlay .profile-media-viewer-slide > video { position:relative; z-index:1; width:100%; height:100%; max-height:100%; display:block; object-fit:cover; background:transparent; user-select:none; }
