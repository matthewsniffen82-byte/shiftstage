...
function DashboardStyles() {
  return (
    <style>{`
      ...
      .dancer-profile-builder-media-empty { display:grid; align-content:center; justify-items:center; gap:9px; padding:22px; border-style:dashed !important; border-color:rgba(126,234,255,.32) !important; color:#f9f8fb; background:radial-gradient(circle at 50% 38%,rgba(124,58,237,.22),transparent 13rem),#07070b !important; cursor:pointer; }
