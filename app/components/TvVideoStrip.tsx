...
function TvVideoStripStyles() {
  return (
    <style>{`
      ...
      .tv-video-viewer-stage > video { width: 100%; height: 100%; min-height: 0; display: block; object-fit: cover; background: transparent; touch-action: none; user-select: none; -webkit-user-select: none; }
      ...
      .tv-video-viewer-close { position: absolute; z-index: 3; top: calc(16px + env(safe-area-inset-top, 0px)); right: calc(16px + env(safe-area-inset-right, 0px)); width: 44px; height: 44px; display: grid; place-items: center; padding: 0; border: 1px solid rgba(255,255,255,.24); border-radius: 50%; color: #fff; background-color: rgba(5,5,10,.5); background-image: linear-gradient(155deg, rgba(255,255,255,.13), rgba(255,255,255,.035)); box-shadow: inset 0 1px 0 rgba(255,255,255,.16), inset 0 -1px 0 rgba(255,255,255,.035), 0 10px 26px rgba(0,0,0,.32); line-height: 1; cursor: pointer; -webkit-backdrop-filter: blur(14px) saturate(1.12); backdrop-filter: blur(14px) saturate(1.12); }
