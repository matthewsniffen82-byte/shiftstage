  ...
  return (
    <style>{`
      * { box-sizing: border-box; }
      ...
      .profile-media-video-controls button { width: 36px; min-width: 36px; max-width: 36px; height: 36px; min-height: 36px; max-height: 36px; display: inline-flex; align-items: center; justify-content: center; padding: 0; border: 0; border-radius: 50%; color: #f5f4f7; background: rgba(255,255,255,.075); box-shadow: none; font-size: 10px; font-weight: 900; cursor: pointer; white-space: nowrap; }
      .profile-media-video-controls .profile-media-playback-control, .profile-media-video-controls .profile-media-sound-control, .profile-media-video-controls .profile-media-fullscreen-control { width: 36px; min-width: 36px; max-width: 36px; height: 36px; min-height: 36px; max-height: 36px; padding: 0; }
      ...
      .profile-media-video-controls input[type="range"] { --profile-inline-video-progress: 0%; width: 100% !important; min-width: 88px !important; height: 16px !important; min-height: 0 !important; margin: 0 !important; padding: 0 !important; appearance: none !important; -webkit-appearance: none !important; border: 0 !important; border-radius: 0 !important; outline-offset: 3px; background: transparent !important; background-image: none !important; box-shadow: none !important; cursor: pointer; }
      .profile-media-video-controls input[type="range"]:focus-visible { outline: 2px solid rgba(126,234,255,.72); }
      ...
      .profile-media-video-controls output { min-width: 64px; color: #f0edf5; font-size: 10px; font-weight: 800; font-variant-numeric: tabular-nums; line-height: 1; text-align: center; white-space: nowrap; }
