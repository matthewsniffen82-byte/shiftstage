  ...
  return (
    <style>{`
      * { box-sizing: border-box; }
      ...
      .profile-media-socials { min-height: 0; display: grid; place-items: center; margin: 0; padding: 10px 0; border: 0; border-radius: 0; background: transparent; box-shadow: none; }
      ...
      .social-list { width: fit-content; max-width: 100%; display: flex; flex-wrap: nowrap; align-items: center; justify-content: center; gap: 0; margin-inline: auto; overflow: visible; scrollbar-width: none; }
      ...
      .social-list a::before { content: ""; position: absolute; inset: 6px; border: 1px solid rgba(226,232,240,.11); border-radius: 50%; background: rgba(9,9,13,.86); box-shadow: none; transition: border-color .16s ease, background .16s ease; }
      ...
      .social-list a svg { position: relative; z-index: 1; width: 17px; height: 17px; display: block; fill: currentColor; stroke: currentColor; stroke-width: 1.8; stroke-linecap: round; stroke-linejoin: round; }
      ...
      .profile-media-viewer-slide { position: relative; width: 100%; height: 100%; min-height: 100%; max-height: 100%; display: grid; grid-template: minmax(0, 1fr) / minmax(0, 1fr); place-items: center; overflow: hidden; background: #000; scroll-snap-align: start; scroll-snap-stop: always; }
      ...
      .profile-media-viewer-slide > img, .profile-media-viewer-slide > video { position: relative; z-index: 1; width: 100%; height: 100%; min-width: 0; min-height: 0; max-height: 100%; display: block; object-fit: cover; background: transparent; user-select: none; }
      ...
      .profile-report-dialog, .profile-schedule-dialog { position: relative; width: min(430px, 100%); max-height: calc(100dvh - 24px); display: grid; gap: 14px; padding: 24px; overflow-y: auto; border: 1px solid rgba(53,216,255,.42); border-radius: 16px; background: linear-gradient(145deg, #0b0b13, #060609); box-shadow: 0 28px 90px rgba(0,0,0,.72); }
      .profile-report-dialog > span, .profile-schedule-dialog > span { color: #7eeaff; font-size: 10px; font-weight: 950; letter-spacing: .14em; text-transform: uppercase; }
      .profile-report-dialog h2 { padding-right: 40px; }
      .profile-report-dialog form > button { min-height: 46px; display: inline-flex; align-items: center; justify-content: center; border: 0; border-radius: 999px; color: #fff; background: linear-gradient(135deg, #6d28d9, #0b94c9); font-weight: 950; text-decoration: none; }
      .profile-report-close, .profile-schedule-dialog-close { position: absolute; top: 12px; right: 12px; width: 38px; height: 38px; display: grid; place-items: center; padding: 0; border: 1px solid rgba(53,216,255,.42); border-radius: 50%; color: #fff; background: #08080d; font-size: 26px; cursor: pointer; }
      ...
      @media (max-width: 600px) {
        ...
        .profile-titlebar-controls { width: 94px; grid-template-columns: repeat(2, 44px); gap: 6px; }
      ...
      @media (max-width: 340px) {
        body.dancr-button-system .public-profile-shell .profile-titlebar { grid-template-columns: minmax(104px, .9fr) minmax(0, 1.1fr) 94px !important; gap: 5px !important; min-height: 62px !important; }
      ...
      @media (max-width: 600px) {
        ...
        body.dancr-button-system .public-profile-shell .profile-titlebar-identity { grid-column: 2 !important; grid-row: 1 !important; align-content: start !important; padding-right: 100px !important; overflow: visible !important; }
        ...
        body.dancr-button-system .public-profile-shell .profile-titlebar-controls { position: absolute !important; top: max(3px, env(safe-area-inset-top)) !important; right: 0 !important; width: 94px !important; }
      ...
      @media (max-width: 340px) {
        ...
        body.dancr-button-system .public-profile-shell .profile-titlebar-identity { padding-right: 100px !important; }
        body.dancr-button-system .public-profile-shell .live-actions { grid-template-columns: repeat(3, minmax(0, 1fr)) !important; }
      }
    `}</style>
  );
