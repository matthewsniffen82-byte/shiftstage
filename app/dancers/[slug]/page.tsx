  ...
  return (
    <style>{`
      * { box-sizing: border-box; }
      ...
      body.dancr-button-system .public-profile-shell .profile-media-tabs button::before { position: absolute; z-index: 0; inset: 3px; content: ""; border: 1px solid rgba(255,255,255,.11); border-radius: 50%; background: rgba(255,255,255,.055); box-sizing: border-box; }
      .profile-media-tab-icon { position: relative; z-index: 1; width: 19px; height: 19px; display: block; fill: none; stroke: currentColor; stroke-width: 1.8; stroke-linecap: round; stroke-linejoin: round; }
