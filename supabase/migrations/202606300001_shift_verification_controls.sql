alter table public.shifts
  ...
  add column if not exists still_working_prompted_at timestamptz,
  add column if not exists still_working_confirmed_at timestamptz,
  add column if not exists still_working_expires_at timestamptz,
  add column if not exists extended_ends_at timestamptz,
