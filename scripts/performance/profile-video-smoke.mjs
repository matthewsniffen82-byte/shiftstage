...
try {
  ...
  const source = await page.locator(".profile-media-viewer video").first().evaluate(video => video.src);
  assert.ok(source && !source.startsWith("blob:") && !source.includes("hls="), "Profile plays its normal video source");
