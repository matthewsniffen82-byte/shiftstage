...
def main() -> None:
    ...
    flow_rows = [
        ...
        ("Payout scheduled", "Payee identity, Bitsafe/Yoursafe beneficiary ID, amount, tax/compliance state", "Bitsafe/Yoursafe executes, holds, or rejects transfer", "Dancer or authorized agent payment account", "Batch/item/reference/status; no provider password or full credentials in app DB"),
